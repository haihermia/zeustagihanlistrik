...
class tb_tagihan_pesan extends CI_Controller{
/*
...
$data = array(
'Id_Tagihan_Pesan'=> $this->input->post('Id_Tagihan_Pesan'),
'Id_Tagihan'=> $this->input->post('Id_Tagihan'),
'Id_Pesan'=> $this->input->post('Id_Pesan')
);
$this->M_tb_tagihan_pesan->save($data);
...
'edit' => $this->M_tb_tagihan_pesan->edit($kd)
);
...
$this->M_tb_tagihan_pesan->update($kd,$data);
redirect($this->redirect,'refresh');
}
...
$this->M_tb_tagihan_pesan->delete($data);
redirect($this->redirect,'refresh');
}
}