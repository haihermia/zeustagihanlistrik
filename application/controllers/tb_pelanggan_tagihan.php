...
class tb_pelanggan_tagihan extends CI_Controller{
/*
...
*/
private $view = "backend/v_tb_pelanggan_tagihan/";
//memanggil control Admin/index dalam keadaan refresh
private $redirect = "tb_pelanggan_tagihan";
public function __construct()
{
parent::__construct();
//control Admin menghubungkan model M_admin
$this->load->model('M_tb_pelanggan_tagihan');
}
function index(){
//memanggil model M_admin dengan function GetAll
$read = $this->M_tb_pelanggan_tagihan->GetAll();
$data = array(
...
$data = array(
'Id_Pelanggan_Tagihan'=> $this->input->post('Id_Pelanggan_Tagihan'),
'Id_Pelanggan'=> $this->input->post('Id_Pelanggan'),
'Id_Tagihan'=> $this->input->post('Id_Tagihan')
);
$this->M_tb_pelanggan_tagihan->save($data);
...
'edit' => $this->M_tb_pelanggan_tagihan->edit($kd)
);
...
$this->M_tb_pelanggan_tagihan->update($kd,$data);
redirect($this->redirect,'refresh');
}
